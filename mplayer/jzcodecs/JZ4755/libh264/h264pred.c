...
#ifdef JZC_TCSM_OPT
#include "jzsoc/jzh264/h264pred_mxu.c"
#endif //JZC_TCSM_OPT
...
//    MpegEncContext * const s = &h->s;
    ...
    if(codec_id != CODEC_ID_RV40){
        ...
        if(codec_id == CODEC_ID_SVQ3)
            h->pred4x4[DIAG_DOWN_LEFT_PRED ]= pred4x4_down_left_svq3_mxu;
        else
    ...
    switch(codec_id){
    case CODEC_ID_SVQ3:
       h->pred16x16[PLANE_PRED8x8  ]= pred16x16_plane_svq3_mxu;
       break;
    case CODEC_ID_RV40:
...
#if 0
void mtv_ff_h264_pred_init(H264PredContext *h, int codec_id){
//    MpegEncContext * const s = &h->s;
