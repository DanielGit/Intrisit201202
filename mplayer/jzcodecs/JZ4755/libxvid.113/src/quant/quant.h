 ...
 *
 * $Id: quant.h,v 1.5 2009/05/16 00:19:33 yzhai Exp $
 *
 ****************************************************************************/
...
#else
typedef uint32_t (quant_intraFunc) (
									 int16_t * data,
									const uint32_t quant,
									const uint32_t dcscalar,
									const uint16_t * mpeg_quant_matrices);
...
#else
quant_intraFunc dequant_h263_intra_mxu;
quant_intraFunc dequant_mpeg_intra_mxu;
#endif
