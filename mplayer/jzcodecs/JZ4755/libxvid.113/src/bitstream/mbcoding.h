 ...
 *
 * $Id: mbcoding.h,v 1.2 2009/06/19 06:21:06 gysun Exp $
 *
 ****************************************************************************/
...
/* 
 *the next define be delete,so JZC_GET_OPT never be difined. 
 *#define JZC_GET_OPT
*/
#ifdef JZC_GET_OPT
...
#endif //JZC_GET_OPT
/*
*jz1:the next 3 fuction be moved from mbcoding.c 
*/
#if 1
static __inline int
