...
// install init plugin
  printf ("+++ install_init_plugin_complete = %d  +++\n", install_init_plugin_complete);
  return;
}
...
struct AV_PLUGIN_TBL ffmpeg_plugin_table [] = 
{
  ...
  //{"cmmb", "ffmpeg_vd_mtvh264",  0},
//
  //{"h264", "ffmpeg_vd_h264",  0},
  {"h264", "ffmpeg_vd_mtvh264",  0},
  {"svq3", "ffmpeg_vd_h264",  0},
//
...
//
  ...
  {"theora", "ffmpeg_vd_mpegvideo", 0},
  {"vp3", "ffmpeg_vd_mpegvideo", 0},
  ...
  {"vp5", "ffmpeg_vd_mpegvideo", 0},
  {"vp6", "ffmpeg_vd_mpegvideo", 0},
  {"vp6f", "ffmpeg_vd_mpegvideo", 0},
  {"vp6a", "ffmpeg_vd_mpegvideo", 0},
