...
#ifndef __LINUX__
void (*ff_mspel_motion_funcp)() = NULL;
void (*ff_h261_loop_filter_funcp)(MpegEncContext *s) = NULL;
#endif
...
#ifndef __LINUX__
		if(ff_h261_loop_filter_funcp)
        	ff_h261_loop_filter_funcp(s);
#else
...
#ifndef __LINUX__
            if (ff_mspel_motion_funcp)
              ff_mspel_motion_funcp(s, dest_y, dest_cb, dest_cr,
                        ref_picture, pix_op,
                        s->mv[dir][0][0], s->mv[dir][0][1], 16);
#else
