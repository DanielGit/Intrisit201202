...
#ifdef HAVE_ANDROID_OS /* Wolfgang, 05-12-2009 */
extern ao_functions_t audio_out_audioflinger;
#endif
...
#else
extern ao_functions_t audio_out_noahos;
extern ao_functions_t audio_out_pcm;
#endif
...
#ifndef __LINUX__
   {
//   kprintf("init_best_audio_out:\n");
			ao_functions_t* audio_out=&audio_out_noahos;
//      ao_functions_t* audio_out=&audio_out_pcm;
