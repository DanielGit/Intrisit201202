...
//        for(i=0; i<25; i++) printf("%02X ", ((uint8_t*)data)[i]);
    ...
    if(pic->pict_type & 0x100)
    {
        ...
        //cli();
        short d1 = *(volatile unsigned int *)0xB380D000;
        short d2 = *(volatile unsigned int *)0xB380D028;
        //sti();
        F("d1 = %x, d2 = %x\n",d1,d2);
        
        int dcycle = d1 - d2;//*(volatile unsigned int *)0xB380D000 - *(volatile unsigned int *)0xB380D028;
