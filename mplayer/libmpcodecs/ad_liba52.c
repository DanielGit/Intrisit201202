...
#ifndef __LINUX__
ad_functions_t *ad_liba52_table (void)
{
  return &mpcodecs_ad_liba52;
}
#endif
...
static int init(sh_audio_t *sh_audio)
{
  ...
  sample_t level=a52_level, bias=0;
  int flags=0;
#if 0
  /* Dolby AC3 audio:*/
...
static int decode_audio(sh_audio_t *sh_audio,unsigned char *buf,int minlen,int maxlen)
{
    sample_t level=a52_level, bias=384;
        //level will be scaled in a52_frame(),
        // the scal coeffcient is 1<<26, so level must less than 1<<5!!!!
