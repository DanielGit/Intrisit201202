...
#if RELEASE_TO_AUDIO
static int audio_decode_flag = 0; 
#endif
...
//			kprintf("time_fram = %f,margin = %f, time_frame - margin = %f\n",time_frame , margin,time_frame - margin);
...
decode_video:	
			...
			decoded_frame = decode_video(sh_video, start, in_size, drop_frame,
										 sh_video->pts);
		  #if MP_STATISTIC
		  int releasetoautio = 0;
		  if(decoded_frame)
		  	releasetoautio = (((mp_image_t *)decoded_frame)->pict_type & 0x100)?1:0;
		  if(releasetoautio == 0)
		  {	
			...
			{
				mp_image_t *mpi = (mp_image_t *)decoded_frame;
				if(mpi)
					printf("decoded_frame->plane[0] = %x %d\n",mpi->planes[0],mpi->pict_type);
			}
			#endif
			current_module = "filter_video";
				...
				{		
					  #if RELEASE_TO_AUDIO
					  audio_decode_flag = (((mp_image_t *)decoded_frame)->pict_type & 0x100);
						if(audio_decode_flag)
						{
							//#undef printf
							printf("goto audio_decode\n");
...
cli();
 printf("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
 printf("a_dec_count = %d v_dec_count = %d av_total_count = %d\n",av_a_dec_count,av_v_dec_count,av_total_count);
 printf("a_dec_time = %d(us) v_dec_time = %d(us) av_total_time = %d(us)\n",av_a_dec_time / av_a_dec_count,av_v_dec_time / av_v_dec_count,av_total_time / av_total_count);
 printf("other_total_time = %d(us)\n",av_total_time / av_total_count - av_v_dec_time / av_v_dec_count - av_a_dec_time / av_a_dec_count);
 printf("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
