/* JZ MXU instructions simulation in C code
 *
 *   fanoble [2007-07-24 20:05:59]
 */
...
struct jzunaligned_32 { unsigned int l; } __attribute__((packed));
#define LD32(a) (((const struct jzunaligned_32 *) (a))->l)
#define ST32(a, b) (((struct jzunaligned_32 *) (a))->l) = (b)
