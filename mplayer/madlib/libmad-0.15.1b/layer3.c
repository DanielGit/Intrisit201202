 ...
 *
 * $Id: layer3.c,v 1.2 2008/12/20 13:39:37 xyzhang Exp $
 */
...
void III_aliasreduce(mad_fixed_t xr[576], int lines)
{
  ...
  for (xr += 18; xr < bound; xr += 18) {
      mad_fixed_t tmpx = (mad_fixed_t) (xr - 1);
      mad_fixed_t tmpy = (mad_fixed_t) (xr);
    for (i = 0; i < 8; ++i) {
...
# endif
        tmp0 = a; tmp1 = cs[i];
        tmp2 = -b; tmp3 = ca[i];
        S32MUL(xr1,xr3,tmp0, tmp1);
        tmp0 = b;
        S32MADD(xr1,xr3,tmp2, tmp3);
        tmp2 = a;
        S32MUL(xr2,xr4,tmp0, tmp1);
        S32MADD(xr2,xr4,tmp2, tmp3);

        S32EXTR(xr1,xr3,4,31);
        S32EXTR(xr2,xr4,4,31);

        D32SLL(xr1,xr1,xr2,xr2,1);
        S32SDI(xr1,tmpy,-4);
        S32SDI(xr2,tmpx,4);
...
{
  mad_fixed_t a9,  a10, a11, a5, a14, a15, a16, a17;
//  mad_fixed_t a13, a18, a19, a20, a21, a22, a23, a24, a25;
  mad_fixed_t tmp0, tmp1, tmp2, tmp3;
  enum {
  ...
  */
  ...
  S32LDD(xr8, x, 28);  //x[7];
  S32LDD(xr9, x, 32);  //x[8];
  D32ADD_AS(xr4,xr4,xr6,xr6);//xr4 = a0; xr6 = a1;
  D32ADD_AS(xr7,xr7,xr3,xr3);//xr7 = a2; xr3 = a3;
  D32ADD_AS(xr2,xr2,xr8,xr8);//xr2 = a4; xr8 = a5;
  D32ADD_AS(xr9,xr9,xr1,xr1);//xr9 = a6; xr1 = a7;

  /*pass2 use a0,a1,a2,a3,a6,a7,a8,a13
    a8  = a0  + a2;
    a9  = a0  - a2;
    a10 = a0  - a6;
    a11 = a2  - a6;
    ...
    a17 = a1  + a3;
  */
  D32ADD_AS(xr10,xr4,xr7,xr11); //xr10 = a8; xr11 = a9;
  D32ASUM_SS(xr4,xr9,xr9,xr7);  //xr4 = a10; xr7 = a11;
  D32ADD_SA(xr12,xr6,xr3,xr13);//xr12 = a13; xr13 = a17;
  D32ASUM_AS(xr3,xr1,xr1,xr6);  //xr3 = a15; xr6 = a16;
  D32ASUM_AA(xr10,xr9,xr1,xr12);  //xr10 = a12; xr12 = a14;
  ...
  /*pass3 use a5,a9,a10,a11,a14,a15,a16,a17
  ...
  tmp0 = a17; tmp1 = -c3;
  tmp2 = a16; tmp3 = -c0;
  S32MUL(xr3,xr8,tmp0, tmp1);
  tmp0 = a15; tmp1 = -c4;
  S32MUL(xr4,xr11,tmp2, tmp3);
  tmp2 = a14; tmp3 = -c1;
  S32MUL(xr6,xr12,tmp0, tmp1);
  S32MUL(xr7,xr13,tmp2, tmp3);
  S32EXTR(xr3,xr8,4,31);
  S32EXTR(xr4,xr11,4,31);
  S32EXTR(xr6,xr12,4,31);
  S32EXTR(xr7,xr13,4,31);

  tmp0 = a5; tmp1 = -c1;
  tmp2 = a11; tmp3 = -c6;
  S32MUL(xr8,xr14,tmp0, tmp1);
  S32MUL(xr11,xr15,tmp2, tmp3);
  S32EXTR(xr8,xr14,4,31);
  S32EXTR(xr11,xr15,4,31);

  tmp0 = a10; tmp1 = -c5;
  tmp2 = a9; tmp3 = -c2;
  S32MUL(xr12,xr14,tmp0, tmp1);
  S32MUL(xr13,xr15,tmp2, tmp3);
  S32EXTR(xr12,xr14,4,31);
  S32EXTR(xr13,xr15,4,31);

  D32SLL(xr3,xr3,xr4,xr4,1);
  D32SLL(xr6,xr6,xr7,xr7,1);
  D32SLL(xr8,xr8,xr11,xr11,1);
  D32SLL(xr12,xr12,xr13,xr13,1);


  /*save m0 ~ m7 ,a4,a12*/
  /*pass4 use a4,a19,m1,m2,m4,m5,m6
    a18 =     x[4] + a4;
    a19 = 2 * x[4] - a4;
    a20 = a19 + m5;
    a21 = a19 - m5;
    ...
    a25 = m4  + m1;
  */
  D32ADD_AS(xr14,xr5,xr2,xr2);  //xr14 = a18; xr2 = x[4] - a4;
  D32ADD_AS(xr9,xr8,xr6,xr6);  //xr9 = a23; xr6 = a24;

  D32ASUM_AA(xr5,xr2,xr4,xr8);  //xr5 = a19; xr8 = a25;
  S32STD(xr7,y,24); //  y[ 6] = m3;
  D32ADD_AS(xr1,xr5,xr11,xr2);  //xr1 = a20; xr2 = a21;
  D32ASUM_AA(xr5,xr12,xr3,xr9);  //xr5 = a22; xr9 = y[14];

  /*pass5 use a12 = xr10, a18 = xr14, a20 =xr1 , a21 = xr2, a22 = xr5,
    a23 = xr9, a24 = xr6, a25  = xr8, m0 = xr3, m1 = xr4, m3 = xr7,
    m6 = xr12, m7 = xr13
    y[ 0] = a18 + a12;
    y[ 2] = m0  - a25;
    y[ 4] = m7  - a20;
  ...
  */
  ...
  D32ADD_AS(xr11,xr10,xr14,xr10);  //xr11 = y[0]; xr10 = a12-a18;
  D32ASUM_AS(xr5,xr13,xr12,xr2);   //xr5 = y[16]; xr2 = y[8];
  D32ASUM_SS(xr3,xr8,xr1,xr13);    //xr3 = y[2]; xr13 = y[4];
  D32ASUM_SS(xr6,xr4,xr14,xr10);   //xr6 = y[10]; xr10 = y[12];
  S32STD(xr11,y,0);
  S32STD(xr3,y,8);
  S32STD(xr13,y,16);
  S32STD(xr2,y,32);
...
void sdctII(mad_fixed_t const x[18], mad_fixed_t X[18])
{
  ...
  mad_fixed_t inx = (mad_fixed_t) (x - 1);
  mad_fixed_t iny = (mad_fixed_t) (x + 18);
  mad_fixed_t tmpx = (mad_fixed_t) (tmp - 1);
  for (i = 0; i < 9; i += 3) {
    ...
    S32LDI(xr5,inx,4);
    S32LDI(xr6,iny,-4);
    D32ASUM_AA(xr1,xr2,xr4,xr3);
    D32ASUM_AA(xr5,xr6,xr0,xr0);
  ...
  tmpx = (mad_fixed_t) (tmp - 1);
  for (i = 0; i < 9; i += 3) {
    tmp0 = x[i + 0] - x[17 - i]; tmp1 = scale[i + 0];
    tmp2 = x[i + 1] - x[16 - i]; tmp3 = scale[i + 1];
    S32MUL(xr1,xr2,tmp0, tmp1);
    tmp0 = x[i + 2] - x[15 - i]; tmp1 = scale[i + 2];
    S32MUL(xr3,xr4,tmp2, tmp3);
    S32MUL(xr5,xr6,tmp0, tmp1);
    S32EXTR(xr1,xr2,4,31);
    S32EXTR(xr3,xr4,4,31);
    S32EXTR(xr5,xr6,4,31);
...
void dctIV(mad_fixed_t const y[18], mad_fixed_t X[18])
{
  ...
  */
  tmpx = (uint32_t) (tmp - 1);
  for (i = 0; i < 18; i += 3) {
    tmp0 = y[i + 0]; tmp1 = scale[i + 0];
    tmp2 = y[i + 1]; tmp3 = scale[i + 1];
    S32MUL(xr1,xr2,tmp0, tmp1);
    tmp0 = y[i + 2]; tmp1 = scale[i + 2];
    S32MUL(xr3,xr4,tmp2, tmp3);
    S32MUL(xr5,xr6,tmp0, tmp1);
    S32EXTR(xr1,xr2,4,31);
    S32EXTR(xr3,xr4,4,31);
  ...
  for (i = 1; i < 17; i += 4) {
    ...
    S32LDI(xr3,tmpx,4);
    S32LDI(xr4,tmpx,4);
    /* xr1 = X[i + 0]; xr5 = X[i + 0] / 2;
       xr2 = X[i + 1]; xr6 = X[i + 1] / 2;
       xr3 = X[i + 2]; xr7 = X[i + 2] / 2;
       xr4 = X[i + 3]; xr8 = X[i + 3] / 2;
    */
    D32SAR(xr5,xr1,xr2,xr2,1);
    /*X[i + 0] = xr1; X[i + 1] = xr2*/
    D32ACCM_SS(xr1,xr5,xr9,xr2);

    D32SAR(xr7,xr3,xr4,xr4,1);
    S32STD(xr1,tmpx,-12);
    /*X[i + 2] = xr3; X[i + 3] = xr4*/
    D32ACCM_SS(xr3,xr7,xr2,xr4);
    S32STD(xr2,tmpx,-8);
    S32STD(xr3,tmpx,-4);
    S32STD(xr4,tmpx,0);
  }
...
# elif 1
    {
      mad_fixed_t tmpz0 = (mad_fixed_t) (z - 1);
      for (i = 0; i < 36; i += 4) {
        tmp0 = z[i + 0]; tmp1 = window_l[i + 0];
        tmp2 = z[i + 1]; tmp3 = window_l[i + 1];
        S32MUL(xr1,xr2,tmp0, tmp1);
        tmp0 = z[i + 2]; tmp1 = window_l[i + 2];
        S32MUL(xr3,xr4,tmp2, tmp3);
        tmp2 = z[i + 3]; tmp3 = window_l[i + 3];
        S32MUL(xr5,xr6,tmp0, tmp1);
        S32MUL(xr7,xr8,tmp2, tmp3);
        S32EXTR(xr1,xr2,4,31);
        S32EXTR(xr3,xr4,4,31);
        S32EXTR(xr5,xr6,4,31);
        S32EXTR(xr7,xr8,4,31);
        D32SLL(xr1,xr1,xr3,xr3,1);
...
# endif
  ...
  case 1:  /* start block */
    {
      mad_fixed_t tmpz1 = (mad_fixed_t) (z - 1);
      for (i =  0; i < 18; i += 3) {
        tmp0 = z[i + 0]; tmp1 = window_l[i + 0];
        tmp2 = z[i + 1]; tmp3 = window_l[i + 1];
        S32MUL(xr1,xr2,tmp0, tmp1);
      ...
      tmpz1 = (mad_fixed_t) (z + 23);
      for (i = 24; i < 30; i += 2) {
        tmp0 = z[i + 0]; tmp1 =  window_s[i - 18];
        tmp2 = z[i + 1]; tmp3 =  window_s[(i + 1) - 18];
        S32MUL(xr1,xr2,tmp0, tmp1);
        S32MUL(xr3,xr4,tmp2, tmp3);
        S32EXTR(xr1,xr2,4,31);
        S32EXTR(xr3,xr4,4,31);
  ...
  case 3:  /* stop block */
    for (i =  0; i <  6; ++i) z[i] = 0;
    mad_fixed_t tmpz3 = (mad_fixed_t) (z + 5);
    for (i =  6; i < 12; i += 2) {
      tmp0 = z[i + 0]; tmp1 =  window_s[i - 6];
      tmp2 = z[i + 1]; tmp3 =  window_s[(i + 1) - 6];
      S32MUL(xr1,xr2,tmp0, tmp1);
      S32MUL(xr3,xr4,tmp2, tmp3);
      S32EXTR(xr1,xr2,4,31);
      S32EXTR(xr3,xr4,4,31);
...
void III_imdct_s(mad_fixed_t const X[18], mad_fixed_t z[36])
{
  ...
  for (w = 0; w < 3; ++w) {
    ...
    for (i = 0; i < 3; ++i) {
      S32MUL(xr2,xr1, X[0], (*s)[0]);
      S32MADD(xr2,xr1, X[1], (*s)[1]);
      S32MADD(xr2,xr1, X[2], (*s)[2]);
      S32MADD(xr2,xr1, X[3], (*s)[3]);
      S32MADD(xr2,xr1, X[4], (*s)[4]);
      S32MADD(xr2,xr1, X[5], (*s)[5]);
      
      S32EXTR(xr2,xr1,4,31);
      D32SLL(xr2,xr2,xr0,xr0,1);
  ...
  for (i = 0; i < 6; ++i) {
    z[i +  0] = 0;
    S32MUL(xr2,xr1,yptr[ 0 + 0], wptr[0]);
    S32EXTR(xr2,xr1,4,31);
    D32SLL(xr2,xr2,xr0,xr0,1);
    z[i +  6] = S32M2I(xr2);
    S32MUL(xr2,xr1,yptr[ 0 + 6], wptr[6]);
    S32MADD(xr2,xr1,yptr[12 + 0], wptr[0]);
    S32EXTR(xr2,xr1,4,31);
    D32SLL(xr2,xr2,xr0,xr0,1);

    z[i + 12] = S32M2I(xr2);

    S32MUL(xr2,xr1,yptr[ 12 + 6], wptr[6]);
    S32MADD(xr2,xr1,yptr[24 + 0], wptr[0]);
    S32EXTR(xr2,xr1,4,31);
    D32SLL(xr2,xr2,xr0,xr0,1);

    z[i + 18] = S32M2I(xr2);
    S32MUL(xr2,xr1,yptr[24+6], wptr[6]);
    S32EXTR(xr2,xr1,4,31);
    D32SLL(xr2,xr2,xr0,xr0,1);
    z[i + 24] = S32M2I(xr2);
