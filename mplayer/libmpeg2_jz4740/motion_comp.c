 ...
 * $Id: motion_comp.c,v 1.1 2009/02/20 00:44:18 dsqiu Exp $
 */
...
#else
static void MC_avg_o_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 { do { dest[0] = (((ref[0])+dest[0]+1)>>1);
        dest[1] = (((ref[1])+dest[1]+1)>>1);
        dest[2] = (((ref[2])+dest[2]+1)>>1);
        dest[3] = (((ref[3])+dest[3]+1)>>1);
        dest[4] = (((ref[4])+dest[4]+1)>>1);
        dest[5] = (((ref[5])+dest[5]+1)>>1);
        dest[6] = (((ref[6])+dest[6]+1)>>1);
        dest[7] = (((ref[7])+dest[7]+1)>>1);
        dest[8] = (((ref[8])+dest[8]+1)>>1);
        dest[9] = (((ref[9])+dest[9]+1)>>1);
        dest[10] = (((ref[10])+dest[10]+1)>>1);
        dest[11] = (((ref[11])+dest[11]+1)>>1);
        dest[12] = (((ref[12])+dest[12]+1)>>1);
        dest[13] = (((ref[13])+dest[13]+1)>>1);
        dest[14] = (((ref[14])+dest[14]+1)>>1);
        dest[15] = (((ref[15])+dest[15]+1)>>1);
        ref += stride;
        dest += stride;
      } while (--height);
  }
...
static void MC_put_x_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 {
   ...
   do {
       ...
       S32ALN(xr11,xr14,xr15,3);
       S32ALN(xr10,xr13,xr14,3);
       S32ALN(xr9, xr12,xr13,3);
...
static void MC_put_x_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 {
   do {
        dest[0] = (((ref[0]+ref[0 +1]+1)>>1));
        dest[1] = (((ref[1]+ref[1 +1]+1)>>1));
        dest[2] = (((ref[2]+ref[2 +1]+1)>>1));
        dest[3] = (((ref[3]+ref[3 +1]+1)>>1));
        dest[4] = (((ref[4]+ref[4 +1]+1)>>1));
        dest[5] = (((ref[5]+ref[5 +1]+1)>>1));
        dest[6] = (((ref[6]+ref[6 +1]+1)>>1));
        dest[7] = (((ref[7]+ref[7 +1]+1)>>1));
        dest[8] = (((ref[8]+ref[8 +1]+1)>>1));
        dest[9] = (((ref[9]+ref[9 +1]+1)>>1));
        dest[10] = (((ref[10]+ref[10 +1]+1)>>1));
        dest[11] = (((ref[11]+ref[11 +1]+1)>>1));
        dest[12] = (((ref[12]+ref[12 +1]+1)>>1));
        dest[13] = (((ref[13]+ref[13 +1]+1)>>1));
        dest[14] = (((ref[14]+ref[14 +1]+1)>>1));
        dest[15] = (((ref[15]+ref[15 +1]+1)>>1));
        ref  += stride;
        dest += stride;
       } while (--height);
  }
...
static void MC_put_x_8_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 {
  int32_t ref_aln,ref_rs0,ref_rs1;
   ...
   do {
       ...
       S32ALN(xr5,xr14,xr15,3);
       //S32ALN(xr5,xr2,xr1,ref_rs1); //xr5:ref[4]-[1]
...
#else
 static void MC_avg_x_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 { do { dest[0] = (((((ref[0]+ref[0 +1]+1)>>1))+dest[0]+1)>>1);
        dest[1] = (((((ref[1]+ref[1 +1]+1)>>1))+dest[1]+1)>>1);
        dest[2] = (((((ref[2]+ref[2 +1]+1)>>1))+dest[2]+1)>>1);
        dest[3] = (((((ref[3]+ref[3 +1]+1)>>1))+dest[3]+1)>>1);
        dest[4] = (((((ref[4]+ref[4 +1]+1)>>1))+dest[4]+1)>>1);
        dest[5] = (((((ref[5]+ref[5 +1]+1)>>1))+dest[5]+1)>>1);
        dest[6] = (((((ref[6]+ref[6 +1]+1)>>1))+dest[6]+1)>>1);
        dest[7] = (((((ref[7]+ref[7 +1]+1)>>1))+dest[7]+1)>>1);
        dest[8] = (((((ref[8]+ref[8 +1]+1)>>1))+dest[8]+1)>>1);
        dest[9] = (((((ref[9]+ref[9 +1]+1)>>1))+dest[9]+1)>>1);
        dest[10] = (((((ref[10]+ref[10 +1]+1)>>1))+dest[10]+1)>>1);
        dest[11] = (((((ref[11]+ref[11 +1]+1)>>1))+dest[11]+1)>>1);
        dest[12] = (((((ref[12]+ref[12 +1]+1)>>1))+dest[12]+1)>>1);
        dest[13] = (((((ref[13]+ref[13 +1]+1)>>1))+dest[13]+1)>>1);
        dest[14] = (((((ref[14]+ref[14 +1]+1)>>1))+dest[14]+1)>>1);
        dest[15] = (((((ref[15]+ref[15 +1]+1)>>1))+dest[15]+1)>>1);
        ref += stride;
        dest += stride;
       } while (--height);
 }
...
static void MC_put_y_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 {
   ...
   do {
        ...
        S32ALN(xr6,xr10,xr0,0);
        S32ALN(xr7,xr11,xr0,0);
        S32ALN(xr8,xr12,xr0,0);
        S32ALN(xr9,xr13,xr0,0);

     } while (--height);
 }
#else
static void MC_put_y_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 { do { dest[0] = (((ref[0]+(ref+stride)[0]+1)>>1));
        dest[1] = (((ref[1]+(ref+stride)[1]+1)>>1));
        dest[2] = (((ref[2]+(ref+stride)[2]+1)>>1));
        dest[3] = (((ref[3]+(ref+stride)[3]+1)>>1));
        dest[4] = (((ref[4]+(ref+stride)[4]+1)>>1));
        dest[5] = (((ref[5]+(ref+stride)[5]+1)>>1));
        dest[6] = (((ref[6]+(ref+stride)[6]+1)>>1));
        dest[7] = (((ref[7]+(ref+stride)[7]+1)>>1));
        dest[8] = (((ref[8]+(ref+stride)[8]+1)>>1));
        dest[9] = (((ref[9]+(ref+stride)[9]+1)>>1));
        dest[10] = (((ref[10]+(ref+stride)[10]+1)>>1));
        dest[11] = (((ref[11]+(ref+stride)[11]+1)>>1));
        dest[12] = (((ref[12]+(ref+stride)[12]+1)>>1));
        dest[13] = (((ref[13]+(ref+stride)[13]+1)>>1));
        dest[14] = (((ref[14]+(ref+stride)[14]+1)>>1));
        dest[15] = (((ref[15]+(ref+stride)[15]+1)>>1));
        ref += stride;
        dest += stride;
      } while (--height);
  }
...
static void MC_put_y_8_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 {
  ...
  do {
        ...
        S32ALN(xr4,xr6,xr0,0);
        S32ALN(xr5,xr7,xr0,0);
 ...
 {
   do {
        dest[0] = (((((ref[0]+(ref+stride)[0]+1)>>1))+dest[0]+1)>>1);
        dest[1] = (((((ref[1]+(ref+stride)[1]+1)>>1))+dest[1]+1)>>1);
        dest[2] = (((((ref[2]+(ref+stride)[2]+1)>>1))+dest[2]+1)>>1);
        dest[3] = (((((ref[3]+(ref+stride)[3]+1)>>1))+dest[3]+1)>>1);
        dest[4] = (((((ref[4]+(ref+stride)[4]+1)>>1))+dest[4]+1)>>1);
        dest[5] = (((((ref[5]+(ref+stride)[5]+1)>>1))+dest[5]+1)>>1);
        dest[6] = (((((ref[6]+(ref+stride)[6]+1)>>1))+dest[6]+1)>>1);
        dest[7] = (((((ref[7]+(ref+stride)[7]+1)>>1))+dest[7]+1)>>1);
        dest[8] = (((((ref[8]+(ref+stride)[8]+1)>>1))+dest[8]+1)>>1);
        dest[9] = (((((ref[9]+(ref+stride)[9]+1)>>1))+dest[9]+1)>>1);
        dest[10] = (((((ref[10]+(ref+stride)[10]+1)>>1))+dest[10]+1)>>1);
        dest[11] = (((((ref[11]+(ref+stride)[11]+1)>>1))+dest[11]+1)>>1);
        dest[12] = (((((ref[12]+(ref+stride)[12]+1)>>1))+dest[12]+1)>>1);
        dest[13] = (((((ref[13]+(ref+stride)[13]+1)>>1))+dest[13]+1)>>1);
        dest[14] = (((((ref[14]+(ref+stride)[14]+1)>>1))+dest[14]+1)>>1);
        dest[15] = (((((ref[15]+(ref+stride)[15]+1)>>1))+dest[15]+1)>>1);
        ref += stride;
        dest += stride;
      } while (--height);
 }
...
static void MC_avg_y_8_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
{
...
#else
  static void MC_avg_y_8_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 { do { dest[0] = (((((ref[0]+(ref+stride)[0]+1)>>1))+dest[0]+1)>>1);
        dest[1] = (((((ref[1]+(ref+stride)[1]+1)>>1))+dest[1]+1)>>1);
        dest[2] = (((((ref[2]+(ref+stride)[2]+1)>>1))+dest[2]+1)>>1);
        dest[3] = (((((ref[3]+(ref+stride)[3]+1)>>1))+dest[3]+1)>>1);
        dest[4] = (((((ref[4]+(ref+stride)[4]+1)>>1))+dest[4]+1)>>1);
 ...
 static void MC_put_xy_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 {
      ...
      do
      {
        ...
        S32ALN(xr8,xr5,xr4,3);       //xr8:ref[16]-[13]
        S32ALN(xr7,xr4,xr3,3);       //xr7:ref[12]-[9]
        S32ALN(xr6,xr3,xr2,3);       //xr6:ref[8]-[5]
        S32ALN(xr5,xr2,xr1,3);       //xr5:ref[4]-[1]
        ...
        S32ALN(xr5,xr6,xr5,3);
        S32ALN(xr6,xr7,xr6,3);
        S32ALN(xr7,xr8,xr7,3);
        S32ALN(xr8,xr9,xr8,3);
...
#else
 static void MC_put_xy_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 { do { dest[0] = (((ref[0]+ref[0 +1]+(ref+stride)[0]+(ref+stride)[0 +1]+2)>>2));
        dest[1] = (((ref[1]+ref[1 +1]+(ref+stride)[1]+(ref+stride)[1 +1]+2)>>2));
        dest[2] = (((ref[2]+ref[2 +1]+(ref+stride)[2]+(ref+stride)[2 +1]+2)>>2));
        dest[3] = (((ref[3]+ref[3 +1]+(ref+stride)[3]+(ref+stride)[3 +1]+2)>>2));
        dest[4] = (((ref[4]+ref[4 +1]+(ref+stride)[4]+(ref+stride)[4 +1]+2)>>2));
        dest[5] = (((ref[5]+ref[5 +1]+(ref+stride)[5]+(ref+stride)[5 +1]+2)>>2));
        dest[6] = (((ref[6]+ref[6 +1]+(ref+stride)[6]+(ref+stride)[6 +1]+2)>>2));
        dest[7] = (((ref[7]+ref[7 +1]+(ref+stride)[7]+(ref+stride)[7 +1]+2)>>2));
        dest[8] = (((ref[8]+ref[8 +1]+(ref+stride)[8]+(ref+stride)[8 +1]+2)>>2));
        dest[9] = (((ref[9]+ref[9 +1]+(ref+stride)[9]+(ref+stride)[9 +1]+2)>>2));
        dest[10] = (((ref[10]+ref[10 +1]+(ref+stride)[10]+(ref+stride)[10 +1]+2)>>2));
        dest[11] = (((ref[11]+ref[11 +1]+(ref+stride)[11]+(ref+stride)[11 +1]+2)>>2));
        dest[12] = (((ref[12]+ref[12 +1]+(ref+stride)[12]+(ref+stride)[12 +1]+2)>>2));
        dest[13] = (((ref[13]+ref[13 +1]+(ref+stride)[13]+(ref+stride)[13 +1]+2)>>2));
        dest[14] = (((ref[14]+ref[14 +1]+(ref+stride)[14]+(ref+stride)[14 +1]+2)>>2));
        dest[15] = (((ref[15]+ref[15 +1]+(ref+stride)[15]+(ref+stride)[15 +1]+2)>>2));
        ref += stride;
        dest += stride;
        } while (--height);
 }
...
static void MC_put_xy_8_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 {
   uint32_t ref_aln, ref_rs, ref_rs1;
      ...
      dest -= stride;
        ...
        S32ALN(xr4,xr8,xr0,0);
        S32ALN(xr5,xr9,xr0,0);
        S32ALN(xr6,xr10,xr0,0);
        S32ALN(xr7,xr11,xr0,0);
...
#else
 static void MC_avg_xy_16_c (uint8_t * dest, const uint8_t * ref, const int stride, int height)
 { do { dest[0] = (((((ref[0]+ref[0 +1]+(ref+stride)[0]+(ref+stride)[0 +1]+2)>>2))+dest[0]+1)>>1);
        dest[1] = (((((ref[1]+ref[1 +1]+(ref+stride)[1]+(ref+stride)[1 +1]+2)>>2))+dest[1]+1)>>1);
        dest[2] = (((((ref[2]+ref[2 +1]+(ref+stride)[2]+(ref+stride)[2 +1]+2)>>2))+dest[2]+1)>>1);
        dest[3] = (((((ref[3]+ref[3 +1]+(ref+stride)[3]+(ref+stride)[3 +1]+2)>>2))+dest[3]+1)>>1);
        dest[4] = (((((ref[4]+ref[4 +1]+(ref+stride)[4]+(ref+stride)[4 +1]+2)>>2))+dest[4]+1)>>1);
        dest[5] = (((((ref[5]+ref[5 +1]+(ref+stride)[5]+(ref+stride)[5 +1]+2)>>2))+dest[5]+1)>>1);
        dest[6] = (((((ref[6]+ref[6 +1]+(ref+stride)[6]+(ref+stride)[6 +1]+2)>>2))+dest[6]+1)>>1);
        dest[7] = (((((ref[7]+ref[7 +1]+(ref+stride)[7]+(ref+stride)[7 +1]+2)>>2))+dest[7]+1)>>1);
        dest[8] = (((((ref[8]+ref[8 +1]+(ref+stride)[8]+(ref+stride)[8 +1]+2)>>2))+dest[8]+1)>>1);
        dest[9] = (((((ref[9]+ref[9 +1]+(ref+stride)[9]+(ref+stride)[9 +1]+2)>>2))+dest[9]+1)>>1);
        dest[10] = (((((ref[10]+ref[10 +1]+(ref+stride)[10]+(ref+stride)[10 +1]+2)>>2))+dest[10]+1)>>1);
        dest[11] = (((((ref[11]+ref[11 +1]+(ref+stride)[11]+(ref+stride)[11 +1]+2)>>2))+dest[11]+1)>>1);
        dest[12] = (((((ref[12]+ref[12 +1]+(ref+stride)[12]+(ref+stride)[12 +1]+2)>>2))+dest[12]+1)>>1);
        dest[13] = (((((ref[13]+ref[13 +1]+(ref+stride)[13]+(ref+stride)[13 +1]+2)>>2))+dest[13]+1)>>1);
        dest[14] = (((((ref[14]+ref[14 +1]+(ref+stride)[14]+(ref+stride)[14 +1]+2)>>2))+dest[14]+1)>>1);
        dest[15] = (((((ref[15]+ref[15 +1]+(ref+stride)[15]+(ref+stride)[15 +1]+2)>>2))+dest[15]+1)>>1);
        ref += stride;
        dest += stride;
       } while (--height);
 }
...
#endif
 mpeg2_mc_t mpeg2_mc_c = { {MC_put_o_16_c, MC_put_x_16_c, MC_put_y_16_c, MC_put_xy_16_c, MC_put_o_8_c,
 MC_put_x_8_c, MC_put_y_8_c, MC_put_xy_8_c}, {MC_avg_o_16_c, MC_avg_x_16_c, MC_avg_y_16_c, MC_avg_xy_16_c,
