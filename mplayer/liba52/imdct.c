...
#define BUTTERFLY_0(t0,t1,W0,W1,d0,d1) do {	\
    int _rb = 2;                                \
    S32MUL(xr2,xr1,W1,d1);\
    S32MUL(xr6,xr5,W0,d1);\
    S32MADD(xr2,xr1,W0,d0);\
    S32MSUB(xr6,xr5,W1,d0);\
    S32EXTR(xr2,xr1,_rb,31);			\             
    S32EXTR(xr6,xr5,_rb,31);			\
    D32SLL(xr9,xr2,xr6,xr10,1);            \
    t0 = S32M2I(xr9);\
    t1 = S32M2I(xr10);\
} while (0)
...
#define BUTTERFLY_ZERO(b0,b1,b2,b3) do {	\
    complex_t *a0 = &b0;\
    complex_t *a1 = &b1;\
    complex_t *a2 = &b2;\
    complex_t *a3 = &b3;\
    ...
    S32LDI(xr8, a3, 4);\
    S32LDI(xr13, a0, 0);\
    D32ADD_AS(xr1,xr7,xr5,xr4);\
    D32ADD_AS(xr2,xr6,xr8,xr3);\
    S32LDI(xr14, a0, 4);\
    S32LDI(xr15, a1, 0);\
    S32LDI(xr8, a1, 4);\
    D32ADD_SA( xr9,xr13,xr1,xr5);\
    D32ADD_SA(xr10,xr14,xr2,xr6);\
    D32ADD_SA(xr11,xr15,xr3,xr7);\
    D32ADD_SA(xr12,xr8,xr4,xr8);\
    S32SDI( xr9, a2, -4);\
    S32SDI(xr10, a2, 4);\
    S32SDI(xr11, a3, -4);\
    S32SDI(xr12, a3, 4);\
...
#define BUTTERFLY_HALF(b0,b1,b2,b3,w) do {	\
    complex_t *a0 = &b0;\
    complex_t *a1 = &b1;\
    complex_t *a2 = &b2;\
    complex_t *a3 = &b3;\
    ...
    S32LDI(xr3, a3, 0);\
    S32LDI(xr4, a3, 4);\
    D32ADD_AS(xr5, xr2, xr1, xr6);\
    D32ADD_AS(xr7, xr3, xr4, xr8);\
    int i2ar2 = S32M2I(xr5);\
    int i2sr2 = S32M2I(xr6);\
    int r3si3 = S32M2I(xr8);\
    int r3ai3 = S32M2I(xr7);\
    int32_t sp = 2;\
    S32MUL(xr10,xr9,i2ar2,w);\
    S32MUL(xr14,xr13,r3si3,w);\
    S32MUL(xr12,xr11,i2sr2,w);\
    S32MUL(xr8,xr7,r3ai3,w);\
    S32EXTR(xr10,xr9,sp,31);\
    S32EXTR(xr12,xr11,sp,31);\
    S32EXTR(xr14,xr13,sp,31);\
    S32EXTR(xr8,xr7,sp,31);\
    D32SLL(xr9,xr10,xr12,xr11,1);\
    D32SLL(xr13,xr14,xr8,xr7,1);\
    S32LDI(xr12, a0, 0);\ 
    D32ADD_AS(xr1, xr13, xr9, xr2);\
    D32ADD_AS(xr3, xr11, xr7, xr4);\
    S32LDI(xr11, a0, 4);\
    S32LDI(xr10, a1, 0);\
    S32LDI(xr9, a1, 4);\
    D32ADD_AS(xr8, xr12, xr1,xr1);\
    D32ADD_AS(xr7, xr11, xr3,xr3);\
    D32ADD_AS(xr6, xr10, xr4,xr4);\
    D32ADD_AS(xr5, xr9,  xr2,xr2);\
    S32SDI(xr8, a0, -4);\
    S32SDI(xr7, a0, 4);\
    S32SDI(xr6, a1, -4);\
    S32SDI(xr5, a1, 4);\
...
#define BUTTERFLY(b0,b1,b2,b3,wr,wi) do {		\
    complex_t *a0 = &b0;\
    complex_t *a1 = &b1;\
    complex_t *a2 = &b2;\
    complex_t *a3 = &b3;\
    int32_t _rb = 2;    \
    S32MUL(xr2,xr1,wi,b2.imag);\
    S32MUL(xr6,xr5,wr,b2.imag);\
    S32MUL(xr4,xr3,wi,b3.real);\
    S32MUL(xr8,xr7,wr,b3.real);\
    S32MADD(xr2,xr1,wr,b2.real);\
    S32MSUB(xr6,xr5,wi,b2.real);\
    S32MADD(xr4,xr3,wr,b3.imag);\
    S32MSUB(xr8,xr7,wi,b3.imag);\
    S32EXTR(xr2,xr1,_rb,31);\    
    S32EXTR(xr6,xr5,_rb,31);\
    S32EXTR(xr4,xr3,_rb,31);\
    S32EXTR(xr8,xr7,_rb,31);\
    D32SLL(xr9,xr2,xr6,xr10,1);\    
    D32SLL(xr11,xr4,xr8,xr12,1);\
    S32LDI(xr13, a0,0);          \
    S32LDI(xr14,a0,4);          \     
    D32ADD_AS(xr1,xr12, xr9, xr4);\
    D32ADD_AS(xr2,xr10, xr11,xr3);\
    S32LDI(xr15,a1,0);         \
    S32LDI(xr12,a1,4);        \
    D32ADD_SA(xr5,xr13, xr1,xr9);\  
    D32ADD_SA(xr6,xr14,xr2,xr10); \
    D32ADD_SA(xr7,xr15,xr3,xr11);  \
    D32ADD_SA(xr8,xr12,xr4,xr12);  \
    S32SDI(xr5, a2, 0);\
    S32SDI(xr6, a2, 4);\
    S32SDI(xr7, a3, 0);\
    S32SDI(xr8, a3, 4);\
...
static void ifft_pass (complex_t * buf, sample_t * weight, int n)
{
    ...
    BUTTERFLY_ZERO (buf[0], buf1[0], buf2[0], buf3[0]);

    i = n - 1;

    do {
	BUTTERFLY (buf[1], buf1[1], buf2[1], buf3[1],
