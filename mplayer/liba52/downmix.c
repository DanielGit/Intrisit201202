		      ...
		      level_t clev, level_t slev)
{
	...
	case CONVERT (A52_3F2R, A52_2F2R):
	    ...
	    adjust = DIV (LEVEL_ONE, LEVEL (1) + clev);
	    break;
	...
	case CONVERT (A52_3F1R, A52_3F):
	    adjust = DIV (LEVEL_ONE, LEVEL (1) + MUL_C (slev, LEVEL_3DB));
	    break;

	case CONVERT (A52_3F1R, A52_MONO):
	    //adjust = DIV (LEVEL_3DB, LEVEL (1) + clev + MUL_C (slev, 0.5));
	    adjust = DIV (LEVEL_3DB, LEVEL (1) + clev + MUL_C (slev, LEVEL_6DB));
	    break;

	case CONVERT (A52_3F1R, A52_STEREO):
	    adjust = DIV (LEVEL_ONE, LEVEL (1) + clev + MUL_C (slev, LEVEL_3DB));
	    break;
	...
	case CONVERT (A52_3F2R, A52_3F):
	    adjust = DIV (LEVEL_ONE, LEVEL (1) + slev);
	    break;
	...
	case CONVERT (A52_3F2R, A52_STEREO):
	    adjust = DIV (LEVEL_ONE, LEVEL (1) + clev + slev);
	    break;
