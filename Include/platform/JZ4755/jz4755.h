 ...
 *************************************************************************/
#define CPM_CPCCR	(CPM_BASE+0x00)/* RW, 32, 0x42040000, Clock Control Register*/
#define CPM_LCR		(CPM_BASE+0x04)/* RW, 32, 0x000000F8, Low Power Control Register*/
...
#define CPM_MSCCDR	(CPM_BASE+0x68) /* MSC0 & MSC1device share the same clock divider Register */
...
#define CPM_CLKGR_AIC_PCLK		( 1 << 5 )
#define CPM_CLKGR_SSI1			( 1 << 4 )
#define CPM_CLKGR_I2C			( 1 << 3 )
#define CPM_CLKGR_RTC			( 1 << 2 )
#define CPM_CLKGR_TCU			( 1 << 1 )
#define CPM_CLKGR_UART0		( 1 << 0 )
#define CPM_CLKGR_AIC1		CPM_CLKGR_AIC_PCLK
#define CPM_CLKGR_AIC2		CPM_CLKGR_AIC_PCLK
...
/*
 * MSC0_CLK----->PB15(PFUN = 1	PTRG = 1		PSEL = 0)
 * MSC0_CMD---->PC16(PFUN = 1	PTRG = 1		PSEL = 0)
 * MSC0_D0------>PC28(PFUN = 1	PTRG = 0		PSEL = 1)
 * MSC0_D1------>PC29(PFUN = 1	PTRG = 0		PSEL = 1)
 * MSC0_D3------>PC17(PFUN = 1	PTRG = 0		PSEL = 1)
...
do {										\
	...
	REG_GPIO_PXPES(1)   = 0x00008000;	\
	/*MSC0_CMD*/						\
	REG_GPIO_PXFUNS(2) = 0x00010000;	\
	REG_GPIO_PXTRGS(2) = 0x00010000;	\
	REG_GPIO_PXSELC(2) = 0x00010000;	\
	REG_GPIO_PXPES(2)   = 0x00010000;	\
	/*MSC0_D0,D1,D3*/					\
	REG_GPIO_PXFUNS(2) = 0x30020000;	\
	REG_GPIO_PXTRGC(2) = 0x30020000;	\
	REG_GPIO_PXSELS(2)  = 0x30020000;	\
	REG_GPIO_PXPES(2)   = 0x30020000;	\
	/*MSC0_D2*/						\
...
static __inline__ int __dmac_get_irq(void)
{
	...
	for (i = 0; i < MAX_DMA_NUM; i++)
		if (__dmac_channel_irq_detected(i/HALF_DMA_NUM, i%HALF_DMA_NUM))
			return i;
	return -1;
}
