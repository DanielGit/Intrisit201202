...
#define DAC_CONFIG_REG              (0xB002E000)	//DAC
#define I2S_CONFIG_REG              (0xB002E004)	//I2S

#define ADC2_MODE_CFG				(0xB0072000)
#define WORD_LEN_CONFIG_BIT             (8)
#define I2S_RECEIVE_EN_BIT              (4)
#define CHANNEL_POL_SEL_BIT             (3)
#define HOST_INT_STATUS_BIT             (2)
#define L2_EN_BIT                       (1)
#define ADC_EN_BIT                      (0)

#define ADC2_REC_REG				(0xB0072000 + 0X4)
...
#define PWM_CTRL_REG3	    	    (ADC_MODULE_BASE_ADDR + 0xb4)
#define PWM_CTRL_REG4	    	    (ADC_MODULE_BASE_ADDR + 0xb8)
...
#define ANALOG_CTRL1_PD_REF                     (1 << 0)                   // for Ref Voltage Generator           
#define ANALOG_CTRL1_PD_ADC2                    (1 << 1)                   // for ADC2/ADC3                       
#define ANALOG_CTRL1_PD_ADC3                    (1 << 2)                   // for ADC2/ADC3// for ADC2/ADC3       
#define ANALOG_CTRL1_ADC2_3_IN_MASK             (0x7 << 3)                 // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN(source)          (((source)&0x7) << 3)      // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_RESERVED         ANALOG_CTRL1_ADC2_3_IN(0)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_DACS             ANALOG_CTRL1_ADC2_3_IN(1)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_LINEIN           ANALOG_CTRL1_ADC2_3_IN(2)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_LINEIN_DACS      ANALOG_CTRL1_ADC2_3_IN(3)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_MP               ANALOG_CTRL1_ADC2_3_IN(4)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_MP_DACS          ANALOG_CTRL1_ADC2_3_IN(5)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_MP_LINEIN        ANALOG_CTRL1_ADC2_3_IN(6)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_ADC2_3_IN_MP_LINEIN_DACS   ANALOG_CTRL1_ADC2_3_IN(7)  // for ADC2/ADC3                       
#define ANALOG_CTRL1_LINE_GAIN_MASK             (0x3 << 6)                 // for Linein                          
#define ANALOG_CTRL1_LINE_GAIN(gain)            (((gain)&0x3) << 6)        // for Linein                          
#define ANALOG_CTRL1_LINE_GAIN_06X              ANALOG_CTRL1_LINE_GAIN(0)  // for Linein                          
#define ANALOG_CTRL1_LINE_GAIN_10X              ANALOG_CTRL1_LINE_GAIN(1)  // for Linein                          
#define ANALOG_CTRL1_LINE_GAIN_15X              ANALOG_CTRL1_LINE_GAIN(2)  // for Linein                          
#define ANALOG_CTRL1_LINE_GAIN_20X              ANALOG_CTRL1_LINE_GAIN(3)  // for Linein                          
#define ANALOG_CTRL1_MIC_GAIN_MASK              (0x3 << 8)                 // for Microphone                      
#define ANALOG_CTRL1_MIC_GAIN(gain)             (((gain)&0x3) << 8)        // for Microphone                      
#define ANALOG_CTRL1_MIC_GAIN_5X                ANALOG_CTRL1_MIC_GAIN(0)   // for Microphone                      
#define ANALOG_CTRL1_MIC_GAIN_10X               ANALOG_CTRL1_MIC_GAIN(1)   // for Microphone                      
#define ANALOG_CTRL1_MIC_GAIN_15X               ANALOG_CTRL1_MIC_GAIN(2)   // for Microphone                      
#define ANALOG_CTRL1_MIC_GAIN_20X               ANALOG_CTRL1_MIC_GAIN(3)   // for Microphone                      
#define ANALOG_CTRL1_PD_MIC                     (1 << 10)                  // for Microphone                      
#define ANALOG_CTRL1_PD_LINE_L                  (1 << 11)                  // for Linein                          
#define ANALOG_CTRL1_PD_LINE_R                  (1 << 12)                  // for Linein                          
#define ANALOG_CTRL1_PD_CK                  (1 << 13)                  // for DACs                            
#define ANALOG_CTRL1_PD_OP                     (1 << 14)                  // for DACs                            
#define ANALOG_CTRL1_PRE_EN2                     (1 << 15)                  // for DACs
#define ANALOG_CTRL1_HP_IN_MASK                 (0x7 << 16)                // for Headphone
#define ANALOG_CTRL1_HP_IN(source)              (((source)&0x7) << 16)     // for Headphone
#define ANALOG_CTRL1_HP_IN_MUTE                 ANALOG_CTRL1_HP_IN(0)      // for Headphone
#define ANALOG_CTRL1_HP_IN_DACS                 ANALOG_CTRL1_HP_IN(1)      // for Headphone
#define ANALOG_CTRL1_HP_IN_LINEIN               ANALOG_CTRL1_HP_IN(2)      // for Headphone
#define ANALOG_CTRL1_HP_IN_LINEIN_DACS          ANALOG_CTRL1_HP_IN(3)      // for Headphone
#define ANALOG_CTRL1_HP_IN_MP                   ANALOG_CTRL1_HP_IN(4)      // for Headphone
#define ANALOG_CTRL1_HP_IN_MP_DACS              ANALOG_CTRL1_HP_IN(5)      // for Headphone
#define ANALOG_CTRL1_HP_IN_MP_LINEIN            ANALOG_CTRL1_HP_IN(6)      // for Headphone
#define ANALOG_CTRL1_HP_IN_MP_LINEIN_DACS       ANALOG_CTRL1_HP_IN(7)      // for Headphone
#define ANALOG_CTRL1_PD_HP                      (1 << 19)                // for Headphone
#define ANALOG_CTRL1_PRE_EN                     (1 << 20)                  // for Headphone 
#define ANNLOG_CTRL1_PD_MID                     (1 << 21)
#define ANALOG_CTRL1_VCM1_3_CTRL                (1 << 22)
#define ANALOG_CTRL1_BYPASS_LINEIN              (1 << 23)                  // for Linein & DACs
#define ANALOG_CTRL1_PD_VCM                     (1 << 24)                  // for Ref Voltage Generator
#define ANALOG_CTRL1_ADC2_3_LIM                 (1 << 25)                  // for ADC2/ADC3

#define ANALOG_CTRL2_48K_MODE                   (1 << 12)                  // for ADC2/ADC3
#define ANALOG_CTRL2_16K_MODE                   (0 << 12)                  // for ADC2/ADC3
#define ANALOG_CTRL2_DAC_EN                     (1 << 13)                  // for DACs
...
#define CLKDIV2_DAC_DIS_RST             (1 << 24)     //if write 0 to this bit, it will reset DAC

/** clock divider reigister 2  bit map*/
#define CLKDIV2_DAC_DIV(val)            (((val)&0xFF) << 13)    //[20:13]dac clock = PLLCLK/(CLK_DIV2_DAC_DIV+1)
#define CLKDIV2_DAC_CLKEN               (1 << 21)     //TO ENABLE DAC CLK
#define CLKDIV2_DAC_GATE                (1 << 26)     //inhibit dac clk for dac
#define CLKDIV2_I2S_MCLK_MASK           (3 << 27)     //I2S_MACK = 1
#define CLKDIV2_I2S_MCLK_DAC_CLK        (2 << 27)     //I2S_MACK = DAC CLK
#define CLKDIV2_DAC_DATA                (1 << 30)     //DAC accept data from CPU/AP
#define CLKDIV2_DAC_DATA                (1 << 30)     //DAC accept data from CPU/AP



/** DAC configuration register bit map*/
#define DAC_CONFIG_ARM_EN                   (1 << 0)
#define DAC_CONFIG_L2_EN                    (1 << 1)
#define DAC_CONFIG_MUTE						(1 << 2)
#define DAC_CONFIG_ARM_INT                  (1 << 3)
/** I2S configuration register bit map*/
#define I2S_CONFIG_CHN_POL                  (1 << 5)
#define I2S_CONFIG_WORDLENGTH_MASK          (0x1F << 0)

#define MASK_CLKDIV1_N					(0xF << 17)
#define MASK_CLKDIV1_AP_CLOCK           (0xE00)       //[11:9]working clock for audio processor 
#define MASK_CLKDIV1_ASIC_DIVIDER       (0x1C0)
#define MASK_CLKDIV1_PLL1_CLOCK         (0x3F)
...
//Multiple_function Control Register

#define MULTIFUNC_CTRL_REG				        (0xB8000058) /*Multiple_function Control Register*/
#define MULTIFUNC_CTRL_OTG_PHY_RST				(1 << 0)
#define MULTIFUNC_CTRL_OTG_REG_EN				(1 << 1)
#define MULTIFUNC_CTRL_OTG_SUS					(1 << 2)
#define MULTIFUNC_CTRL_HOST_SUS					(1 << 3)
#define MULTIFUNC_CTRL_AUDIO_EN					(1 << 10)
#define MULTIFUNC_CTRL_PCM_SLOT1_EN				(1 << 11)
#define MULTIFUNC_CTRL_IN_DAC_ADC_EN			(1 << 23)
#define MULTIFUNC_CTRL_EX_DAC_ADC_EN			(~(1 << 23))
#define MULTIFUNC_CTRL_I2S_MODE_MASK			(7 << 24)
#define MULTIFUNC_CTRL_I2S_TS_EN				(1 << 24)
#define MULTIFUNC_CTRL_I2S_RS_EN				(1 << 25)
#define MULTIFUNC_CTRL_I2S_TM_EN				(1 << 26)
#define MULTIFUNC_CTRL_PCM_EN					(1 << 27)
#define MULTIFUNC_CTRL_PLL2CLK_RST				(1 << 30)
#define MULTIFUNC_CTRL_PLL2CLK_EN				(1 << 31)
