 ...
 *
 *  Create:   2008-12-02, by hyzhang
 *
 *  Maintain: 2008-12-02, by hyzhang
 *
 *
 *******************************************************************************
 */

#ifndef __JZ4750CODEC_H__
#define __JZ4750CODEC_H__
...
*******************************************************************************/
#define CONFIG6_MASK		(0x3 << 6)
#define CONFIG6(x)			((x) << 6)					//x = 0, 1, 2, 3
#define CONFIG7_MASK		(0x1F << 0)
#define CONFIG7(x)			((x) << 0)					//x = 0, 1, 2...31

/*******************************************************************************
*			Address: 16		CGR7 Common Define
*******************************************************************************/
#define CONFIG8_MASK		(0x1F << 0)
#define CONFIG8(x)			((x) << 0)					//x = 0, 1, 2...31
...
#define SB_MIC1				(1 << 7)
#define CONFIG2				(1 << 6)
#define SIDETONE_MASK		(0x3 << 4)
#define SIDETONE(x)			((x) << 4)
#define CONFIG3				(0 << 3)
