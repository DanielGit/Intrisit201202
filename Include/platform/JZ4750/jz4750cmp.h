...
#ifndef __JZ4740CPM_H__
#define __JZ4740CPM_H__
...
#define CPM_MSC0CDR_OFFSET		( 0x68 )	// RW, 32, 0x00000004, MSC0 device clock divider Register
...
#define CPM_SSICDR_OFFSET		( 0x74 )	// RW, 32, 0x00000004, SSI clock divider Register
...
#define A_CPM_MSC0CDR		( CPM_BASE_U_VIRTUAL + CPM_MSC0CDR_OFFSET )
...
#define CPCCR_PLLCLK_DIV1	( 1 << 21 )		// The clock is supplied to MSC, I2S, LCD and USB

#define CPCCR_UDIV_BIT		( 23 )
#define CPCCR_LDIV_BIT		( 16 )
#define CPCCR_MDIV_BIT		( 12 )
#define CPCCR_PDIV_BIT		( 8 )
#define CPCCR_HDIV_BIT		( 4 )
#define CPCCR_CDIV_BIT		( 0 )

#define CPCCR_UDIV_MASK		( 0x1F << CPCCR_UDIV_BIT )
#define CPCCR_LDIV_MASK		( 0x1F << CPCCR_LDIV_BIT )
#define CPCCR_MDIV_MASK		( 0xF << CPCCR_MDIV_BIT )
#define CPCCR_PDIV_MASK		( 0xF << CPCCR_PDIV_BIT )
#define CPCCR_HDIV_MASK		( 0xF << CPCCR_HDIV_BIT )
...
#define LPCDR_LPCS				(1 << 30)
#define LPCDR_LTCS				(1 << 29)
...
#define CLKGR_STOP_CIM_RAM		( 1 << 28 )
#define CLKGR_STOP_IDCT			( 1 << 27 )
#define CLKGR_STOP_DB			( 1 << 26 )
#define CLKGR_STOP_ME			( 1 << 25 )
#define CLKGR_STOP_MC			( 1 << 24 )
#define CLKGR_STOP_TVE			( 1 << 23 )
#define CLKGR_STOP_TSSI			( 1 << 22 )
#define CLKGR_STOP_OWI			( 1 << 21 )
#define CLKGR_STOP_PCM			( 1 << 20 )
#define CLKGR_STOP_MSC1			( 1 << 19 )
#define CLKGR_STOP_SSI0			( 1 << 18 )
#define CLKGR_STOP_UART3		( 1 << 17 )
#define CLKGR_STOP_UART2		( 1 << 16 )
#define CLKGR_STOP_UART1		( 1 << 15 )
#define CLKGR_STOP_UHC			( 1 << 14 )
#define CLKGR_STOP_IPU			( 1 << 13 )
#define CLKGR_STOP_DMAC			( 1 << 12 )
#define CLKGR_STOP_UDC			( 1 << 11 )
#define CLKGR_STOP_LCD			( 1 << 10 )
#define CLKGR_STOP_CIM			( 1 << 9 )
#define CLKGR_STOP_SADC			( 1 << 8 )
#define CLKGR_STOP_MSC0			( 1 << 7 )
#define CLKGR_STOP_AIC_PCLK		( 3 << 5 )
