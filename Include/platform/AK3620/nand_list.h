...
//*******************************************************************
//*******************************************************************
#ifndef _CHIP_NFC_3223_
    #define _CHIP_NFC_3223_
//base address of nandflash controller
    #define NF_REG_BASE_ADDR        0xb0080000  // TBD
// DMA
    #define NF_REG_00_DMA_CTRL      (NF_REG_BASE_ADDR + 0x8000)
    #define NF_REG_04_DMA_EXT_MEM       (NF_REG_BASE_ADDR + 0x8004)
    #define NF_REG_08_DMA_FSI1      (NF_REG_BASE_ADDR + 0x8008)
    #define NF_REG_0C_DMA_FSI2      (NF_REG_BASE_ADDR + 0x800C)
    #define NF_REG_10_W_DAT         (NF_REG_BASE_ADDR + 0x8010)
    #define NF_REG_14_R_DAT         (NF_REG_BASE_ADDR + 0x8014)

// ECC
    #define NF_REG_80_ECC_CTRL1     (NF_REG_BASE_ADDR + 0x8080) // encode mudule start address
    #define NF_REG_90_ECC_CTRL2     (NF_REG_BASE_ADDR + 0x8090) // decode module start address
    #define NF_REG_94_ECC_REI1      (NF_REG_BASE_ADDR + 0x8094) // decode module start address
    #define NF_REG_98_ECC_REI2      (NF_REG_BASE_ADDR + 0x8098) // decode module start address
    #define NF_REG_9C_ECC_BEI       (NF_REG_BASE_ADDR + 0x809C) // decode module start address

// NF controller
    #define NF_REG_00_CMD           (NF_REG_BASE_ADDR + 0x8100)
    #define NF_REG_50_RB1           (NF_REG_BASE_ADDR + 0x8150)
    #define NF_REG_54_RB2           (NF_REG_BASE_ADDR + 0x8154)
    #define NF_REG_58_CTRL_STA      (NF_REG_BASE_ADDR + 0x8158)
    #define NF_REG_5C_CMD_LEN       (NF_REG_BASE_ADDR + 0x815C)
    #define NF_REG_60_DAT_LEN       (NF_REG_BASE_ADDR + 0x8160)
//*******************************************************************
