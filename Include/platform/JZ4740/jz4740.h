...
#define __rtc_enable_Hz_irq()         ( REG_RTC_RCR |= RTC_RCR_HZIE )
#define __rtc_disable_Hz_irq()         ( REG_RTC_RCR &= ~RTC_RCR_HZIE )

#define __rtc_get_1Hz_flag()           ( (REG_RTC_RCR >> RTC_RCR_HZ) & 0x1 )
#define __rtc_clear_1Hz_flag()           ( REG_RTC_RCR &= ~RTC_RCR_HZ )
#define __rtc_get_alarm_flag()           ( (REG_RTC_RCR >> RTC_RCR_AF) & 0x1 )
