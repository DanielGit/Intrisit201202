...
#       endif
    ...
    _Rope_RopeLeaf(__GC_CONST _CharT* __d, size_t __size, allocator_type __a)
        : _Rope_RopeRep<_CharT,_Alloc>(this->_S_leaf, 0, true, __size, __a),
          _M_data(__d)
        {
        if (_S_is_basic_char_type((_CharT *)0)) {
...
struct _Rope_RopeConcatenation : public _Rope_RopeRep<_CharT,_Alloc> {
  public:
    ...
    _Rope_RopeConcatenation(_Rope_RopeRep<_CharT,_Alloc>* __l,
      ...
      : _Rope_RopeRep<_CharT,_Alloc>(this->_S_concat,
...
#   endif
    ...
    _Rope_RopeFunction(char_producer<_CharT>* __f, size_t __size,
      ...
      : _Rope_RopeRep<_CharT,_Alloc>(this->_S_function, 0, true, __size, __a)
      , _M_fn(__f)
#       ifndef __GC
...
struct _Rope_RopeSubstring : public _Rope_RopeFunction<_CharT,_Alloc>,
  ...
  public:
    ...
    virtual void operator()(size_t __start_pos, size_t __req_len,
                            _CharT* __buffer) {
        if((_M_base->_M_tag == this->_S_function)
        	|| (_M_base->_M_tag == this->_S_substringfn))
        {
                char_producer<_CharT>* __fn =
                        ((_Rope_RopeFunction<_CharT,_Alloc>*)_M_base)->_M_fn;
                (*__fn)(__start_pos + _M_start, __req_len, __buffer);
        }
        else if(_M_base->_M_tag == this->_S_leaf)
        {
...
#       endif
        this->_M_tag = this->_S_substringfn;
    }
...
#       endif
   ...
   public:
        ...
        void push_front(_CharT __x)
        {
            ...
            try {
              _M_tree_ptr = this->_S_concat(__left, _M_tree_ptr);
              _S_unref(__old);
              _S_unref(__left);
            }
            catch(...)
...
#           endif
        ...
        rope& append(const_iterator __s, const_iterator __e) {
            ...
            _RopeRep* __result = 
              this->_S_concat(_M_tree_ptr, (_RopeRep*)__appendee);
            _S_unref(_M_tree_ptr);
            _M_tree_ptr = __result;
            return *this;
        }
        ...
        rope& append(const rope& __y) {
            _RopeRep* __result = this->_S_concat(_M_tree_ptr, __y._M_tree_ptr);
            _S_unref(_M_tree_ptr);
            _M_tree_ptr = __result;
            return *this;
        }
    ...
    public:
        ...
        void insert(size_t __p, const _CharT* __i, size_t __n) {
            ...
            _RopeRep* __result = this->_S_concat(__left_result, __right);
            _S_unref(_M_tree_ptr);
            _M_tree_ptr = __result;
        }
...
#           endif
        ...
        _reverse_iterator mutable_rbegin() {
            return _reverse_iterator(mutable_end());
        }

        _reverse_iterator mutable_rend() {
            return _reverse_iterator(mutable_begin());
        }
...
#       ifdef __STD_STUFF
          ...
          // I would really like to get rid of it.
            ...
            _reverse_iterator rend() { return mutable_rend(); }

            _reverse_iterator rbegin() { return mutable_rbegin(); }
