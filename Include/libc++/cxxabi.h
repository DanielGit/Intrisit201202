...
// We use the compiler builtins __SIZE_TYPE__ and ptrdiff_t instead of
...
public:
  /* Indicate whether SRC_PTR of type SRC_TYPE is contained publicly within
     ...
     containment. */
  inline __sub_kind __find_public_src (ptrdiff_t __src2dst,
...
public:
  ...
  virtual bool __do_dyncast (ptrdiff_t __src2dst,
...
public:
  ...
  virtual __sub_kind __do_find_public_src (ptrdiff_t __src2dst,
                                           const void *__obj_ptr,
                                           const __class_type_info *__src_type,
                                           const void *__src_ptr) const;
};
