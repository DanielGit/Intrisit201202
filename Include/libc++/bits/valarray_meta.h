...
namespace std
{
  ...
  template<class _Oper, typename _Tp>
    ...
    public:
        ...
        value_type operator[] (size_t __i) const
        { return _M_expr[this->_M_slice.start () + __i * this->_M_slice.stride ()]; }
        size_t size() const { return this->_M_slice.size (); }
    ...
    public:
        ...
        _SBase (_Array<_Tp> __a, const slice& __s)
                : _M_array (__a._M_data+this->__s.start()), _M_size (this->__s.size()),
                  _M_stride (this->__s.stride()) {}
        value_type operator[] (size_t __i) const
    ...
    public:
        ...
        value_type operator[] (size_t __i) const
        { return _M_expr[_M_index[this->__i]]; }
        size_t size () const { return this->_M_index.size(); }
    ...
    public:
        ...
        value_type operator[] (size_t __i) const
        { return _M_array._M_data[_M_index[this->__i]]; }
        size_t size () const { return this->_M_index.size(); }
