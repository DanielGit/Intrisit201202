...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0x47500000				// 机型识别码
...
#define CONFIG_BIOS_UPDATE_KEY		0xf7
#define CONFIG_BIOS_TEST_KEY		0x82
...
//#define CONFIG_AMP_IO				(32*4+19)		// 功放片选控制IO
...
#define CONFIG_EXTPWR_IO			(32*2+19)		// 外部供电检测IO
