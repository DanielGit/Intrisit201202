...
#define FT_CONFIG_CONFIG_H  <freetype/freetype/config/ftconfig.h>
#endif
...
#define FT_CONFIG_STANDARD_LIBRARY_H  <freetype/freetype/config/ftstdlib.h>
#endif
...
#define FT_CONFIG_OPTIONS_H  <freetype/freetype/config/ftoption.h>
#endif
...
#define FT_CONFIG_MODULES_H  <freetype/freetype/config/ftmodule.h>
#endif
  ...
  /*                                                                       */
#define FT_FREETYPE_H  <freetype/freetype/freetype.h>
  ...
  /*                                                                       */
#define FT_ERRORS_H  <freetype/freetype/fterrors.h>
  ...
  /*                                                                       */
#define FT_MODULE_ERRORS_H  <freetype/freetype/ftmoderr.h>
  ...
  /*    It is included by @FT_FREETYPE_H.                                  */
  /*                                                                       */
#define FT_SYSTEM_H  <freetype/freetype/ftsystem.h>
  ...
  /*    It is included by @FT_FREETYPE_H.                                  */
  /*                                                                       */
#define FT_IMAGE_H  <freetype/freetype/ftimage.h>
  ...
  /*    It is included by @FT_FREETYPE_H.                                  */
  /*                                                                       */
#define FT_TYPES_H  <freetype/freetype/fttypes.h>
  ...
  /*                                                                       */
#define FT_LIST_H  <freetype/freetype/ftlist.h>
  ...
  /*                                                                       */
#define FT_OUTLINE_H  <freetype/freetype/ftoutln.h>
  ...
  /*                                                                       */
#define FT_SIZES_H  <freetype/freetype/ftsizes.h>
  ...
  /*                                                                       */
#define FT_MODULE_H  <freetype/freetype/ftmodapi.h>
  ...
  /*                                                                       */
#define FT_RENDER_H  <freetype/freetype/ftrender.h>
  ...
  /*                                                                       */
#define FT_TYPE1_TABLES_H  <freetype/freetype/t1tables.h>
  ...
  /*    specifications.                                                    */
  /*                                                                       */
#define FT_TRUETYPE_IDS_H  <freetype/freetype/ttnameid.h>
  ...
  /*    format.                                                            */
  /*                                                                       */
#define FT_TRUETYPE_TABLES_H  <freetype/freetype/tttables.h>
  ...
  /*                                                                       */
#define FT_TRUETYPE_TAGS_H  <freetype/freetype/tttags.h>
  ...
  /*    face.                                                              */
  /*                                                                       */
#define FT_BDF_H  <freetype/freetype/ftbdf.h>
  ...
  /*                                                                       */
#define FT_GZIP_H  <freetype/freetype/ftgzip.h>
  ...
  /*                                                                       */
#define FT_LZW_H  <freetype/freetype/ftlzw.h>
  ...
  /*                                                                       */
#define FT_WINFONTS_H   <freetype/freetype/ftwinfnt.h>
  ...
  /*                                                                       */
#define FT_GLYPH_H  <freetype/freetype/ftglyph.h>
  ...
  /*                                                                       */
#define FT_BITMAP_H  <freetype/freetype/ftbitmap.h>
  ...
  /*                                                                       */
#define FT_BBOX_H  <freetype/freetype/ftbbox.h>
  ...
  /*                                                                       */
#define FT_CACHE_H  <freetype/freetype/ftcache.h>
...
#define FT_CACHE_CHARMAP_H     FT_CACHE_H
  ...
  /*    works though).                                                     */
  /*                                                                       */
#define FT_MAC_H  <freetype/freetype/ftmac.h>
  ...
  /*                                                                       */
#define FT_MULTIPLE_MASTERS_H  <freetype/freetype/ftmm.h>
  ...
  /*    in SFNT-based font formats (i.e. TrueType and OpenType).           */
  /*                                                                       */
#define FT_SFNT_NAMES_H  <freetype/freetype/ftsnames.h>
  ...
  /*                                                                       */
#define FT_OPENTYPE_VALIDATE_H  <freetype/freetype/ftotval.h>


  /* */

#define FT_TRIGONOMETRY_H       <freetype/freetype/fttrigon.h>
#define FT_STROKER_H            <freetype/freetype/ftstroke.h>
#define FT_SYNTHESIS_H          <freetype/freetype/ftsynth.h>
#define FT_ERROR_DEFINITIONS_H  <freetype/freetype/fterrdef.h>

#define FT_CACHE_MANAGER_H  <freetype/freetype/cache/ftcmanag.h>

#define FT_CACHE_INTERNAL_MRU_H      <freetype/freetype/cache/ftcmru.h>
#define FT_CACHE_INTERNAL_MANAGER_H  <freetype/freetype/cache/ftcmanag.h>
#define FT_CACHE_INTERNAL_CACHE_H    <freetype/freetype/cache/ftccache.h>
#define FT_CACHE_INTERNAL_GLYPH_H    <freetype/freetype/cache/ftcglyph.h>
#define FT_CACHE_INTERNAL_IMAGE_H    <freetype/freetype/cache/ftcimage.h>
#define FT_CACHE_INTERNAL_SBITS_H    <freetype/freetype/cache/ftcsbits.h>


#define FT_XFREE86_H              <freetype/freetype/ftxf86.h>

#define FT_INCREMENTAL_H          <freetype/freetype/ftincrem.h>

#define FT_TRUETYPE_UNPATENTED_H  <freetype/freetype/ttunpat.h>

  /* now include internal headers definitions from <freetype/internal/...> */

#define  FT_INTERNAL_INTERNAL_H  <freetype/freetype/internal/internal.h>
