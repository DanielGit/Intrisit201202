...
#define CONFIG_MAC_NE350		// 产品型号
#define CONFIG_USB_IDENTIFY_CODE		0xE3500000		// 机型识别码
...
#define CONFIG_CPU_STRING				"AK8803"
#define CONFIG_PRODUCT_STRING			"NE350"
...
#define CONFIG_NAND_BIOS_SIZE		6		// BIOS映象文件最大大小
#define CONFIG_NAND_SYSTEM_SIZE		6		// 程序映象文件最大大小
...
#define CONFIG_NAND_ROMFS_SIZE		4UL	// ROM文件系统大小(M)
#define CONFIG_NAND_SYSCFG_SIZE		0UL		// 系统配置数据区大小(M)	
#define CONFIG_NAND_RAMBK_SIZE		0UL		// 内存备份数据区大小(M)	

#define CONFIG_NAND_FATFS0_SIZE		1100UL	// D盘文件系统大小(M)
#define CONFIG_NAND_FATFS1_SIZE		700UL		// F盘(隐藏FAT文件系统)大小(M)
