...
#define CONFIG_MAC_NP7000		// 产品型号
#define CONFIG_SIMDISK_FNAME			"NP7000+.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4755"
#define CONFIG_PRODUCT_STRING			"NP7000_8GB"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xD700000A				// 机型识别码
...
#define CONFIG_EXTPWR_IO			(32*4+6)		// 外部供电检测IO
...
#endif
#define CONFIG_KSTACK_SIZE	(4*1024+WIN32_STACK_SIZE)	// 内核线程内核堆栈大小
