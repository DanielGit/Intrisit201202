...
#define CONFIG_SIMDISK_FNAME			"BES7100J.dsk"	// 定义模拟磁盘文件名称
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xF710000A				// 机型识别码
...
#define CONFIG_BIOS_UPDATE_KEY		0x404
#define CONFIG_BIOS_TEST_KEY		0x605
...
#define CONFIG_BIOS_LANGUAGE	0	// 定义BIOS语言
...
#define CONFIG_CFG_RAMFILE_SIZE			(4*1024)	// 定义内存配置文件大小
