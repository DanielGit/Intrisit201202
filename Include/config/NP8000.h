...
#endif 
#define CONFIG_KERNEL_HEAP_SIZE		0x600000	// 定义内核堆栈空间大小
#define CONFIG_MEM_PAGE_SIZE 		0x1000
#define CONFIG_APP_LOAD_START		0x400000	// 应用程序加载起始位置

//用户空间大小等宏定义
#define CONFIG_USER_MEMSIZE		(64*1024*1024UL)	//用户空间大小
#define CONFIG_VMMAP_SIZE		(3*1024*1024UL)		//虚拟映射空间大小
#define CONFIG_VMMAP_START		(CONFIG_USER_MEMSIZE - CONFIG_VMMAP_SIZE) //虚拟映射到用户空间的开始地址
...
// 其他硬件相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_POWON_BATVAL		355
...
//模拟器上模拟触摸屏
#define CONFIG_TOUCHPANEL_ENABLE		// 定义是否模拟触摸屏
...
#define CONFIG_CODEC_OPEN_ALWAYS		// 定义是否一直打开CODEC设备
