...
#define CONFIG_MAC_BDS7100		// 产品型号
#define CONFIG_SIMDISK_FNAME			"BDS7100.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4750L"
#define CONFIG_PRODUCT_STRING			"BDS7100"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xBD710000				// 机型识别码
#define CONFIG_USB_MANUFACTORY_STRING	"WWW.FRANKLIN.COM"		// 制作厂商
...
// 内存相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_SDRAM_SIZE			(32*1024*1024)	//内存的大小
#define CONFIG_MMU_ENABLE			// 定义MMU情况	//有MMU定义该宏,没有屏蔽该宏
#ifdef WIN32
#undef CONFIG_MMU_ENABLE
#endif 
#define CONFIG_KERNEL_HEAP_SIZE		0x300000	// 定义内核堆栈空间大小
#define CONFIG_MEM_PAGE_SIZE 		0x1000		// 内存分页的大小
...
#define CONFIG_BIOS_UPDATE_KEY		0x404		// 进入BIOS升级模式按键键值(G键)
#define CONFIG_BIOS_TEST_KEY		0x106		// 进入BIOS按键键值(Z键)
...
//#define CONFIG_AMP_IO				(32*2+19)		// 功放片选控制IO
//#define CONFIG_AMP_ENA				1				// 功放允许
//#define CONFIG_AMP_DIS				0				// 功放禁止

#define CONFIG_PIPO_IO				(32*2+19)		// 波波音控制IO
...
#define CONFIG_TFPWR_IO				(32*2+11)		// TF电源控制
#define CONFIG_TFPWR_ON				0				// TF电源打开控制电平
#define CONFIG_TFPWR_OFF			1				// TF电源关闭控制电平

#define CONFIG_TFDET_IO				(32*2+10)		// TF卡插入检测
#define CONFIG_TFDET_INSERT			0//1			// TF卡插入检测电平
#define CONFIG_TFDET_REMOVE			1//0			// TF卡拔出检测电平

#define CONFIG_CHARGE_IO			(32*2+16)		// 充电检测IO
#define CONFIG_CHARGE_ON			0				// 充电进行检测电平
#define CONFIG_CHARGE_FULL 			1				// 充电满检测电平

#define CONFIG_EXTPWR_IO			(32*2+18)		// 外部供电检测IO
#define CONFIG_EXTPWR_ON			1				// 外部供电进行检测电平
#define CONFIG_EXTPWR_OFF 			0				// 外部供电取消检测电平

#define CONFIG_USB_IO				(32*2+18)		// USB电缆检测IO
...
// NAND FLASH相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_NAND_BIOS_SIZE		6UL				// BIOS映象文件最大大小(M)
#define CONFIG_NAND_SYSTEM_SIZE		16UL			// 程序映象文件最大大小(M)

#define CONFIG_NAND_BOOT_SIZE		(CONFIG_NAND_SYSTEM_SIZE+CONFIG_NAND_BIOS_SIZE+4)
#define CONFIG_NAND_ISOFS_SIZE		CONST64(2100)	// ISO文件系统(光盘文件系统)大小(M)
#define CONFIG_NAND_ROMFS_SIZE		CONST64(600)		// ROM文件系统大小(M)
...
#define CONFIG_NAND_IDT_OFFSET		0x1f8	// 记录系统包大小的数据位置(8Bytes: 4Bytes数据大小 + 4Bytes数据版本)
#define CONFIG_NAND_LOGO_OFFSET		0x1f0	// 记录LOGO应用程序信息的数据位置(8Bytes: 4Bytes数据位置 + 4Bytes的数据大小)
#define CONFIG_NAND_MRES_OFFSET		0x1e8	// 记录多媒体资源库(8Bytes: 4Bytes数据位置 + 4Bytes的数据大小)
...
//#define CONFIG_GRID_ENABLE		// 支持点读网膜
//#define CONFIG_KEY_LIGHT		// 按键指示灯
...
//#define CONFIG_MAKE_BURN_TOOL			// 编译烧录工具
//#define CONFIG_MAKE_BIOS				// 编译BIOS文件
