...
#define CONFIG_BIOS_UPDATE_KEY	0x36
#define CONFIG_BIOS_TEST_KEY	0x26
...
#define CONFIG_MAC_ND750		// 产品型号
#define CONFIG_USB_IDENTIFY_CODE		0xD7500000		// 机型识别码
...
#define CONFIG_PRODUCT_STRING			"ND750"
...
#define CONFIG_NAND_ROMFS_SIZE		800UL	// ROM文件系统大小(M)
#define CONFIG_NAND_SYSCFG_SIZE		0UL		// 系统配置数据区大小(M)	
#define CONFIG_NAND_RAMBK_SIZE		0UL		// 内存备份数据区大小(M)	

#define CONFIG_NAND_FATFS0_SIZE		1000UL	// D盘文件系统大小(M)
