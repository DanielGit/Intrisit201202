...
#define CONFIG_MAC_NP970		// 产品型号
#define CONFIG_USB_IDENTIFY_CODE		0xD9700000		// 机型识别码
...
#define CONFIG_PRODUCT_STRING			"NP970"
...
#define CONFIG_VLCD_XSIZE			320		// 定义虚拟LCD大小
#define CONFIG_VLCD_YSIZE			240		// 定义虚拟LCD大小
/////////////////////////////////////////////////////////////////////////
// NAND FLASH相关条件编译定义
/////////////////////////////////////////////////////////////////////////
...
#define CONFIG_NAND_ROMFS_SIZE		650UL	// ROM文件系统大小(M)
#define CONFIG_NAND_SYSCFG_SIZE		0UL		// 系统配置数据区大小(M)	
#define CONFIG_NAND_RAMBK_SIZE		0UL		// 内存备份数据区大小(M)	

#define CONFIG_NAND_FATFS0_SIZE		1150UL	// D盘文件系统大小(M)
