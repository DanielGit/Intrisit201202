...
#define CONFIG_SIMDISK_FNAME			"lls7100.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4750L"
#define CONFIG_PRODUCT_STRING			"lls7100"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0x71000000				// 机型识别码
...
#define CONFIG_NAND_ISOFS_SIZE		CONST64(2330)	// ISO文件系统(光盘文件系统)大小(M)
#define CONFIG_NAND_ROMFS_SIZE		CONST64(480)		// ROM文件系统大小(M)
