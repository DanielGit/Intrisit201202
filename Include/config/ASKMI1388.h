...
#define CONFIG_MAC_ASKMI1388		// 产品型号
#define CONFIG_SIMDISK_FNAME			"ASKMI1388.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4750L"
#define CONFIG_PRODUCT_STRING			"ASKMI1388"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xA1388000				// 机型识别码
...
#define CONFIG_USB_VENDOR_STRING		""						// 销售商(小于等于8字节)
...
#define CONFIG_NAND_ROMFS_SIZE		CONST64(1280)		// ROM文件系统大小(M)
