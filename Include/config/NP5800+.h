...
#define CONFIG_MCU_JZ4750		// 处理器型号
#define CONFIG_MAC_NP5800		// 产品型号
#define CONFIG_SIMDISK_FNAME			"NP5800+.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4750"
#define CONFIG_PRODUCT_STRING			"NP5800+"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xD580000A				// 机型识别码
...
#define CONFIG_BIOS_UPDATE_KEY		0x25		//字母Z键
#define CONFIG_BIOS_TEST_KEY		0x39		//字母Y键
...
#define CONFIG_AMP_IO				(32*4+10)		// 功放片选控制IO
...
#define CONFIG_NAND_FATFS1_SIZE		CONST64(1500)	// F盘(隐藏FAT文件系统)大小(M)
