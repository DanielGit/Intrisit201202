...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xD7800000				// 机型识别码
...
#define CONFIG_NAND_ISOFS_SIZE		CONST64(900)	// ISO文件系统(光盘文件系统)大小(M)
