...
#define CONFIG_MAC_BDS6100A		// 产品型号
#define CONFIG_SIMDISK_FNAME			"BDS6100A.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4750L"
#define CONFIG_PRODUCT_STRING			"BDS6100A"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xBD61000A				// 机型识别码
...
// 内存相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_SDRAM_SIZE			(16*1024*1024)	//内存的大小
...
#endif
#define CONFIG_KSTACK_SIZE	(8192+WIN32_STACK_SIZE)	// 内核线程内核堆栈大小
