...
#define CONFIG_MAC_JZ4760B		// 产品型号
#define CONFIG_SIMDISK_FNAME			"JZ4760B.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4760B"
#define CONFIG_PRODUCT_STRING			"JZ4760B-DEMO"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0x4760B000				// 机型识别码
...
// 内存相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_SDRAM_SIZE			(256*1024*1024)
...
#define CONFIG_BIOS_UPDATE_KEY		0x0101
#define CONFIG_BIOS_TEST_KEY		0x0102
...
//#define CONFIG_AMP_IO				(32*3+12)		// 功放片选控制IO
...
#define CONFIG_TFPWR_IO				(32*4+9)		// TF电源控制
#define CONFIG_TFPWR_ON				1				// TF电源打开控制电平
#define CONFIG_TFPWR_OFF			0				// TF电源关闭控制电平

#define CONFIG_TFDET_IO				(32*0+28)		// TF卡插入检测
...
#define CONFIG_EXTPWR_IO			(32*4+19)		// 外部供电检测IO
#define CONFIG_EXTPWR_ON			1				// 外部供电进行检测电平
#define CONFIG_EXTPWR_OFF 			0				// 外部供电取消检测电平

#define CONFIG_USB_IO				(32*4+19)		// USB电缆检测IO
...
#define CONFIG_MOUSE_ENABLE
#define CONFIG_USBHOST_ENABLE
