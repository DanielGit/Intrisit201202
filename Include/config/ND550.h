...
// 产品型号、处理器型号相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_ARCH_C33PE		// 处理器架构
#define CONFIG_MCU_C33L27		// 处理器型号
#define CONFIG_MAC_ND550		// 产品型号
#define CONFIG_USB_IDENTIFY_CODE		0xD5500000		// 机型识别码
...
#endif 
#define CONFIG_KERNEL_HEAP_SIZE		0x100000	// 定义内核堆栈空间大小
#define CONFIG_MEM_PAGE_SIZE 		0x1000
#define CONFIG_APP_LOAD_START		0	// 应用程序加载起始位置
...
#define CONFIG_NAND_ISOFS_SIZE		CONST64(128)	// ISO文件系统(光盘文件系统)大小(M)
...
#define CONFIG_NAND_FATFS1_SIZE		CONST64(128)	// F盘(隐藏FAT文件系统)大小(M)
...
#define CONFIG_HZ		64		// 内核TICK时钟频率
#define CONFIG_TIME_SLICE	64		// Context切换最小周期
...
#endif
#define CONFIG_KSTACK_SIZE	(8096+WIN32_STACK_SIZE)	// 内核线程内核堆栈大小
