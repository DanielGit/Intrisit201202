...
#define CONFIG_MAC_JZ4755NB		// 产品型号
#define CONFIG_SIMDISK_FNAME			"JZ4755NB.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4755"
#define CONFIG_PRODUCT_STRING			"JZ4755NB"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0x475500B0				// 机型识别码
...
#define CONFIG_BIOS_UPDATE_KEY		0x102
#define CONFIG_BIOS_TEST_KEY		0x101
...
#define CONFIG_CHARGE_IO			(32*4+6)		// 充电检测IO
#define CONFIG_CHARGE_ON			0				// 充电进行检测电平
#define CONFIG_CHARGE_FULL 			1				// 充电满检测电平

#define CONFIG_EXTPWR_IO			(32*4+7)		// 外部供电检测IO
...
#define CONFIG_NAND_FATFS1_SIZE		CONST64(64)	// F盘(隐藏FAT文件系统)大小(M)
