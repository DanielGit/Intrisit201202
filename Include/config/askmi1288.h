...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xCA100000				// 机型识别码
...
#define CONFIG_NAND_ROMFS_SIZE		CONST64(1250)	// ROM文件系统大小(M)
...
#define CONFIG_DEFAULT_MONTH	12
