...
#define CONFIG_MAC_NC500		// 产品型号
#define CONFIG_SIMDISK_FNAME			"NOAHOSV2-TF.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"JZ4755"
#define CONFIG_PRODUCT_STRING			"NC500"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xC5000000				// 机型识别码
...
#endif 
#define CONFIG_KERNEL_HEAP_SIZE		0x1400000	// 定义内核堆栈空间大小
...
#define CONFIG_BIOS_UPDATE_KEY		0x64
#define CONFIG_BIOS_TEST_KEY		0x61
...
#define CONFIG_TFPWR_IO				(32*4+13)		// TF电源控制
#define CONFIG_TFPWR_ON				0				// TF电源打开控制电平
#define CONFIG_TFPWR_OFF			1				// TF电源关闭控制电平

#define CONFIG_TFDET_IO				(32*4+12)		// TF卡插入检测
#define CONFIG_TFDET_INERT			1				// TF卡插入检测电平
...
#define CONFIG_EXTPWR_IO			(32*4+1)		// 外部供电检测IO
...
#define CONFIG_NAND_ISOFS_SIZE		CONST64(512)	// ISO文件系统(光盘文件系统)大小(M)
...
#define CONFIG_NAND_FATFS1_SIZE		CONST64(512)	// F盘(隐藏FAT文件系统)大小(M)
...
//#define CONFIG_DECODE_IFLYTTS_ENABLE	// 定义是否使用讯飞TTS
//#define CONFIG_DECODE_POCKET_ENABLE	// 定义口袋英语的解码器
//#define CONFIG_FLASH_ENABLE			// 支持SWF媒体播放
