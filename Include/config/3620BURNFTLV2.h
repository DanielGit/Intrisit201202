...
#define CONFIG_MAC_FV580		// 产品型号
#define CONFIG_SIMDISK_FNAME			"NOAHOSV2.dsk"	// 定义模拟磁盘文件名称
#define CONFIG_CPU_STRING				"AK3620/AK3660"
#define CONFIG_PRODUCT_STRING			"ASKMI1188"
...
#endif
#define CONFIG_USB_IDENTIFY_CODE		0xF5800001				// 机型识别码
...
// NAND FLASH相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_NAND_BIOS_SIZE		4UL				// BIOS映象文件最大大小
#define CONFIG_NAND_SYSTEM_SIZE		4UL				// 程序映象文件最大大小
...
#define CONFIG_NAND_ROMFS_SIZE		CONST64(400)	// ROM文件系统大小(M)
#define CONFIG_NAND_SYSCFG_SIZE		CONST64(4)		// 系统配置数据区大小(M)	
#define CONFIG_NAND_RAMBK_SIZE		CONST64(0)		// 内存备份数据区大小(M)	
#define CONFIG_NAND_FATFS1_SIZE		CONST64(0)		// F盘(隐藏FAT文件系统)大小(M)
...
#define CONFIG_CHARSET_WINDOWS_1258		9

#define CONFIG_FS_CHARSET		CONFIG_CHARSET_WINDOWS_1258	//文件系统使用字符集
