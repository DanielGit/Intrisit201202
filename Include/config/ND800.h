...
#define CONFIG_MAC_ND800		// 产品型号
#define CONFIG_SIMDISK_FNAME			"N8.dsk"	// 定义模拟磁盘文件名称
...
#define CONFIG_NAND_ISOFS_SIZE		CONST64(600)	// ISO文件系统(光盘文件系统)大小(M)
...
#define CONFIG_BIOS_LANGUAGE	1	// 定义BIOS语言 0:英文,1:中文

/////////////////////////////////////////////////////////////////////////
// 窗体系统相关条件编译定义
/////////////////////////////////////////////////////////////////////////
#define CONFIG_TOUCH_ENABLE				// 定义是否使用触摸屏
#define CONFIG_TOUCH_SMART				// 定义是否使用手势识别
