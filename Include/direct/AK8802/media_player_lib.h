 ...
 * @brief This file provides MP4/3GP/AVI/AKV/mp3/aac/amr playing functions
 *
 * Copyright (C) 2007 Anyka (Guangzhou) Software Technology Co., LTD
 * @author Su Dan, Zeng Yong
 * @date 2007-8-18
 * @update date 2009-5-20
 * @version 0.2.0
 * @version ever green group version: x.x
 * @note
	The following is an example to use playing APIs
   @code
void play_media(char* filaname);
 ...
 */
const T_CHR *MediaLib_GetVersion(void);
 ...
 * @return T_S32
 * @retval	< 0		play fail
 * @retval	other	if there is video, video time in millisecond
 * @retval	other	if no video, 0 or last seek audio time in millisecond
 */
